...
public abstract class ListTest {
    ...
    @Test
    public void testRetreatFromOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "green", "red");
        List<String> list2 = this.createFromArgsRef(0, "green", "red");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    @Test
    public void testRetreatOnlyOne() {
