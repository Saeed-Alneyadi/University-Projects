...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        /*
         * Set the name of the program as "" and the create and set both Map1L
         * and Statement1 to {@code this.context} and {@code this.body},
         * respectively.
         */
        this.name = "Unnamed";
    ...
    public final void setName(String n) {
        ...
        /*
         * Assign {@code n} to {@code this.name}.
         */
        this.name = n;
    }
    ...
    public final String name() {
        /*
         * RETURN Statement: Returning the name of {@code this}.
         */
        return this.name;
    }
    ...
    public final Map<String, Statement> newContext() {
        /*
         * RETURN Statement: Return a Map<String, Statement> object with the
         * same implementation as {@code this.context}.
         */
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /*
         * Swamping the bodies of {@code this.context} and {@code c} using
         * transferFrom() Method and {@code temp} Map.
         */
    ...
    public final Statement newBody() {
        /*
         * RETURN Statement: Return a Statement object with the same
         * implementation as {@code this.body}.
         */
    ...
    public final void swapBody(Statement b) {
        ...
        /*
         * Swamping the bodies of {@code this.body} and {@code b} using
         * transferFrom() Method and {@code temp} Statement.
         */
